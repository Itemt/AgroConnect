    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudad', models.CharField(blank=True, max_length=100, verbose_name='Ciudad/Municipio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departamento', models.CharField(blank=True, max_length=100, verbose_name='Departamento')),
                ('ciudad', models.CharField(blank=True, max_length=100, verbose_name='Ciudad/Municipio')),
                ('direccion', models.CharField(blank=True, help_text='Ej: Vereda, finca, sector específico', max_length=255, verbose_name='Dirección específica')),
                ('location', models.CharField(blank=True, help_text='Campo legacy - se actualizará automáticamente', max_length=255)),
